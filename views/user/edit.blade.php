    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?php //dd($item) ?>
                {!! Form::model($item, array('route' => array('user/edit', $item->id), 'method' => 'post', 'role' => 'form','enctype'=>'multipart/form-data', 'class' => 'form')) !!}
                ...
                <div class="box-header with-border admin-tools">
                    ...
                    <a href="{!! \URL::route('user/index') !!}" class="btn btn-warning btn-flat"><i class="fa fa-undo fa-fw"></i> Отменить</a>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="form-group has-feedback">
                            {!! Form::text('name', null, array('class'=>'form-control', 'placeholder'=>'John Walker')) !!}
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input name="password" type="password" value="{!! \Crypt::decrypt($item->password) !!}" class="form-control">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input name="password_confirmation" type="password" value="{!! \Crypt::decrypt($item->password) !!}" class="form-control">
                            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                {!! Form::text('phone', null, array('data-inputmask'=>config('config.phone_mask'), 'data-mask', 'class'=>'form-control', 'placeholder'=>config('config.phone_placeholder'))) !!}
                                <!--<input type="text" name="phone" id="phone" class="form-control" data-inputmask='"mask": "0(999) 99-99-99"' data-mask placeholder="0(999) 99-99-99"/>-->
                            </div><!-- /.input group -->
                        </div><!-- /.form group -->
                        ...
                        <div class="form-group">
                            ...
                            @else
                            @endif
                            Загруженное изображение: {!! $item->logo !!}
                        </div>
                        ...
                        <script type="text/javascript">
                            ...
                            CKEDITOR.instances.description.setData(jQuery('input#description').val());
