        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="box-header with-border admin-tools">
                    <a href="{!! \URL::route('user/add') !!}" class="btn btn-primary btn-flat"><i class="fa fa-user-plus fa-fw"></i> Добавить</a>
                </div>
                ...
                <tbody>
                    @foreach($users as $item)
                        <tr>
                            ...
                            <td>{!! $item->name !!}</td>
                            <td>{!! $item->email !!}</td>
                            <td class="logo">{!! Html::image($item->logo) !!}</td>
                            <td>{!! User::getStrRole($item->role) !!}</td>
                            <td>{!! User::getStrStatus($item->status) !!}</td>
                            <td>
                                <a href='{{ URL::route("user/edit", array($item->id)) }}' class="btn btn-primary btn-flat"><i class="fa fa-wrench fa-fw"></i></a>
