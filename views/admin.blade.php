                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            @endif
                            <p>
                                {!! Auth::user()->name !!} - {!! \User::getStrRole(Auth::user()->role) !!}
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{!! URL::route('db/backup_app') !!}">
                            <i class="fa fa-save"></i> <span>Резервная копия приложения</span> <i class="fa pull-right"></i>
                    </a></li>

                </ul>
            </li>
            <li class="treeview">
            <li><a href="{!! URL::route('user/index') !!}">
                    <i class="fa fa-users"></i>
                    <span>Пользователи</span>
                    <span class="label label-primary pull-right">{!! User::all()->count() !!}</span>
                </a></li>
            <li><a href="{!! URL::route('post/index') !!}">
                    <i class="fa fa-file-o"></i>
                    <span>Статьи</span>
                    <span class="label label-success pull-right">{!! Post::all()->count() !!}</span>
                </a></li>
                <!--<ul class="treeview-menu">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-dashboard"></i> <span>Модули</span> <i class="fa pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{!! URL::route('slider/index') !!}">
                            <i class="fa fa-retweet"></i> <span>Слайдер</span> <i class="fa pull-right"></i>
                        </a></li>
                    <li><a href="{!! URL::route('html/index') !!}">
                            <i class="fa fa-code"></i> <span>Html блоки</span> <i class="fa pull-right"></i>
                        </a></li>
                    <li class="divider"></li>
                </ul>
            </li>
...
@section('content')
    ...
    <section class="content-header">
        <h1><?php //echo config('config.roles')[1] ?>
            Обзорное
            <small>окно</small>
        </h1>
        <ol class="breadcrumb">
